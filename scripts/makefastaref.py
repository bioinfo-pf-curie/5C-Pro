...
def usage():
    ...
    print "-a/--input <primers input file>"
...
if __name__ == "__main__":
    ...
    with  pysam.Samfile(inputFile, "rb") as hr : 
        ...
        for rd in hr.fetch(until_eof=True):
            ...
            handle_out.write(rd.qname+"\t"+info1[3]+"\t"+info1[4]+"\t+\t"+info2[3]+"\t"+info2[4]+"\t+\t"+str(0)+"\t"+info1[0]+"-"+info1[1]+"\t"+info2[0]+"-"+info2[1]+"\t"+str(rd.mapping_quality)+"\t"+str(rd.mapping_quality)+"\n")
